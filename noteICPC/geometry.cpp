Geometry:
    ...
    * Distance and hypot calculation [hypot = distance without square root]
    * Degree to radian conversion and vice-versa
    * Rotate a point to a certain degree, w.r.t origin
    * Three point orientation check
    * Point orientation check w.r.t a line
    * Line representation
    ...
    * Vector scaling w.r.t. a percentage [0.0, 1.0]
    * Translate a vector w.r.t a line
    * Dot product of two vectors
    * Cross product of two vectors
    * Normalization of vector
    * Paraline [Vector like line containing two points in which any point can be found]
    * Shortest distance point between a point and a line of two points
    * Angle(∠ABC) of three points a, b and c
    * Point vs line colinear check 
    * Circle
    * Triangle
    * Trapizoid
